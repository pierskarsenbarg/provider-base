...
namespace PiersKarsenbarg.Base
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pierskarsenbarg/pulumi-base";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("PiersKarsenbarg.Base.version.txt");
    ...
    internal sealed class BaseResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public BaseResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
